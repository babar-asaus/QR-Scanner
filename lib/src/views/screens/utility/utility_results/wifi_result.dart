...
class WifiResult extends StatefulWidget {
  final String data;
  const WifiResult({super.key, required this.data});

  @override
  State<WifiResult> createState() => _WifiResultState();
}

class _WifiResultState extends State<WifiResult> {
