...
import 'package:qr_scanner/src/controllers/save_qr_code_controller.dart';
import '../../../../controllers/share_qr_code_controller.dart';
import '../../../widgets/social_widget.dart';

class LocationResult extends StatefulWidget {
  final String data;

  const LocationResult({super.key, required this.data});

  @override
  State<LocationResult> createState() => _LocationResultState();
}

class _LocationResultState extends State<LocationResult> {
                ...
                ElevatedButton(
                  onPressed: () {
                    _shareQrCodeController.shareQRCode(
                      qrKey: _qrKey,
                      context: context,
                      shareText: 'My QR Code: ${widget.data}',
                    );
                  },
