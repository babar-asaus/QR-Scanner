...
import 'package:qr_scanner/src/views/screens/social/social_results/linkedin_result.dart';

import '../../widgets/dashboard_label.dart';
import '../../widgets/social_widget.dart';

class CreateLinkedin extends StatefulWidget {
  const CreateLinkedin({super.key});

  @override
  State<CreateLinkedin> createState() => _CreateLinkedinState();
}

class _CreateLinkedinState extends State<CreateLinkedin> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LinkedinResult(data: inData,),
        ),
      );
    }
  }
